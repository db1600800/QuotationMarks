...
public class TableViewHeadViewH {
	    ...
	    String pageName="";
	    String className="";
		public  TableViewHeadViewH(String pageName,List<CompomentBean> oldBeans) {
		...
		public void analyseRelativeForVertical(List<CompomentBean> oldBeans) {
			...
			m+="@interface "+className+"HeadView : UIViewController<UITableViewDataSource,UITableViewDelegate>\n";
