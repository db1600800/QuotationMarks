 ...
 * TableViewCell
 * */
public class TableViewCellHeadH {
	...
	public TableViewCellHeadH(String pageName,List<CompomentBean> oldBeans) {
	...
	public void analyse(List<CompomentBean> oldBeans) {
		...
		n+="@interface "+className+"TableViewCellHead :UITableViewCell\n";
