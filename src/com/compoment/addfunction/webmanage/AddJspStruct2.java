...
public class AddJspStruct2 {
...

	{
		...
		m+=" <form action=\"/com/"+interfaceBean.projectName.toLowerCase()+"/action/"+interfaceBean.enName+"Action!doAdd.do\" method=\"post\" enctype=\"multipart/form-data\" name=\"myForm\">\n";
	...
	int filecount=0;
		...
		m+="</body>\n";
		m+="</html>\n";
		makeFile( interfaceBean.enName.toLowerCase()+"Add",m);
