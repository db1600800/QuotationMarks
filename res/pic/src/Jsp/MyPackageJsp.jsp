...
<body>
<div style=" width:100%; height:258px;  background-color:背景颜色; ">
<div id="emptyOrErrorMsg"></div> <span id="aTextView" name ="aTextView" style="  font-size: 16px; color: #242424;  ">a</span>
  </div>
</body>
</html>
