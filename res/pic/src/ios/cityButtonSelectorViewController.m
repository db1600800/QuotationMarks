...
#import "cityButtonSelectorTableViewCell.h"
//注入table功能
NSString *cityButtonSelectorCellIdentifier = @"cityButtonSelectorTableViewCell";
NSString *cityButtonSelectorCellHeadIdentifier = @"cityButtonSelectorTableViewCellHead";
@implementation cityButtonSelectorViewController
...
- (void)viewDidLoad
{
    ...
    UINib *cellNib = [UINib nibWithNibName:@"cityButtonSelectorTableViewCell" bundle:nil];
    [tableView registerNib:cellNib forCellReuseIdentifier:cityButtonSelectorCellIdentifier];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    {
        cityButtonSelectorTableViewCell *cell = (cityButtonSelectorTableViewCell*)[self.tableView dequeueReusableCellWithIdentifier:cityButtonSelectorCellIdentifier];
        if (!cell)
        {
            cell = [[[NSBundle mainBundle] loadNibNamed:@"cityButtonSelectorTableViewCell" owner:self options:nil] lastObject];
        }
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *reuseIdentifier = cityButtonSelectorCellIdentifier;
    cityButtonSelectorTableViewCell *cell= [self.cacheCells objectForKey:reuseIdentifier];
    if (!cell) {
        cell=[self.tableView dequeueReusableCellWithIdentifier:cityButtonSelectorCellIdentifier];
