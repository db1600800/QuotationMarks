...
#import "priceUpButtonSelectorTableViewCell.h"
//注入table功能
NSString *priceUpButtonSelectorCellIdentifier = @"priceUpButtonSelectorTableViewCell";
NSString *priceUpButtonSelectorCellHeadIdentifier = @"priceUpButtonSelectorTableViewCellHead";
@implementation priceUpButtonSelectorViewController
...
- (void)viewDidLoad
{
    ...
    UINib *cellNib = [UINib nibWithNibName:@"priceUpButtonSelectorTableViewCell" bundle:nil];
    [tableView registerNib:cellNib forCellReuseIdentifier:priceUpButtonSelectorCellIdentifier];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    {
        priceUpButtonSelectorTableViewCell *cell = (priceUpButtonSelectorTableViewCell*)[self.tableView dequeueReusableCellWithIdentifier:priceUpButtonSelectorCellIdentifier];
        if (!cell)
        {
            cell = [[[NSBundle mainBundle] loadNibNamed:@"priceUpButtonSelectorTableViewCell" owner:self options:nil] lastObject];
        }
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *reuseIdentifier = priceUpButtonSelectorCellIdentifier;
    priceUpButtonSelectorTableViewCell *cell= [self.cacheCells objectForKey:reuseIdentifier];
    if (!cell) {
        cell=[self.tableView dequeueReusableCellWithIdentifier:priceUpButtonSelectorCellIdentifier];
