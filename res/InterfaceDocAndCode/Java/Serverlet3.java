 ...
 */
@WebServlet(urlPatterns = "/Serverlet3", asyncSupported = true)
...
Gson gson = new Gson();
RequestParam3 bean = gson.fromJson(parameter, RequestParam3.class);
		// 2. set the timeout
		ctx.setTimeout(500);
		// 3. add listener
...
/**买家或者卖家关联第三方信息表3*/
CacheRespondParam3 cacheRespondParam3=new CacheRespondParam3(); 
/** 系统用户号 备注:key*/
cacheRespondParam3.systemNo=;//int
/** 系统类别0:买家1：卖家2：批发商 备注:*/
cacheRespondParam3.systemTyoe=;//select
/** 第三方代号类型0：微信OPENID1：安卓设备号2：IOS设备号 备注:*/
cacheRespondParam3.linkType=;//select
/** 第三方代号 如微信公众号对应的OPENID或者系统设备号 备注:*/
cacheRespondParam3.linkNo=;//String
/** 关联时间格式：yyyymmdd hh24miss 备注:*/
cacheRespondParam3.linkTime=;//String
