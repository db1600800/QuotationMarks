 ...
 */
@WebServlet(urlPatterns = "/Serverlet", asyncSupported = true)
...
Gson gson = new Gson();
RequestParam bean = gson.fromJson(parameter, RequestParam.class);
/** 起始日期 备注:*/
...
/**     退款单明细查询 */
CacheRespondParam cacheRespondParam=new CacheRespondParam(); 
/** 查询结果总记录数 备注:满足条件的总记录数*/
cacheRespondParam.B30_ZF_NUM=;//int
