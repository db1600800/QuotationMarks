...
#import "RespondParam13.h"
@implementation RespondParam13
/* 商品代号 备注:key*/
...
@synthesize tradingUnit;
/* 颜色 备注:*/
@synthesize productColor;
/* 是否鲜活0：否1：是 （此属性是否可以不要，归类于商品状态？） 备注:*/
@synthesize isFresh;
/* 原产地名称 备注:*/
@synthesize sourceArea;
/* 是否支持退货0：否 1：是 备注:*/
@synthesize isCanRefund;
/* 是否需要当场处理0：否1：是（是否支持当场处理？） 备注:*/
@synthesize isNeedSpot;
/* 详情URL地址 备注:*/
@synthesize productDetail;
/* 配菜支持天数 备注:*/
@synthesize supportDay;
