...
/**会员订单预览8075290*/
public class CacheRespondParam8075290{
/** 业务开办局 备注:*/
...
/** 优惠手续费 备注:*/
public float B60_SOFT_UP;
/** 优惠配送费 备注:*/
public float B60_SOFT_DOWN;
/**  备注:*/
public String ;
...
/** 循环域开始 备注:*/
public int B13_ENTR_FP_NUM;
/** 业务基本费用 (数组)备注:*/
public float B89_PAY_SUM[];
/** 基本滞纳金 (数组)备注:*/
public float B60_LOTT_AMT3[];
/** 预多收滞纳金 (数组)备注:*/
public float B60_LOTT_AMT5[];
/** 优惠配送费 (数组)备注:*/
public float B60_LOTT_AMT4[];
/** 实收配送费 (数组)备注:*/
public float B05_BALANCE[];
}
